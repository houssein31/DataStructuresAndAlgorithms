...
-- Each row of this table indicates the name and the ID of a salesperson alongside their salary, commission rate, and
-- hire date.
--
--
-- Table: Company
...
-- Each row of this table contains information about one order. This includes the ID of the company, the ID of the
-- salesperson, the date of the order, and the amount paid.
--
--
